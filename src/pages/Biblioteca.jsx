...
function Biblioteca({books}) {
  return (
    <div>
      <div className="min-h-screen flex justify-center bg-gray-200 overflow-hidden">
        <div>
          ...
          <div className="flex gap-4">
            {books.map((books) => (
              ...
              className="flex w-[260px] space-y-4 h-[475px] border-solid border-2 rounded-2xl border-zinc-500 flex-col items-center  text-center mt-[125px] bg-slate-100">
                <div className="flex w-[200px] space-y-4 h-[200px]  rounded-2xl flex-col items-center text-center mt-[20px] bg-gray-300"></div>
