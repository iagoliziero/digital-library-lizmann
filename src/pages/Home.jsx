    ...
    return (
        <div className='h-screen bg-bg-lizmann bg-cover bg-center bg-no-repeat ' > 
            ...
            <div className="flex flex-col items-center justify-center text-center h-[calc(100%-700px)] mt-[170px] gap-4">
                ...
                <div>
                    <button className="bg-brown text-xl text-slate-100 w-[120px] h-[40px] md:h-[40px] md:w-[130] lg:h-[45px] lg:w-[150px] lg:text-xl rounded-3xl mt-4 hover:scale-105 transition">
                        Acessar
                    </button>
                </div>
            </div>
